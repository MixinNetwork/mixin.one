...
export const IntegratedSecuritySolutionSection = () => {
  return (
    <div className="bg-zinc-100 pt-25 pb-45">
      <div className="container mx-auto max-w-2/3 space-y-5">
        <div className="text-center text-[#333] text-2xl font-normal leading-9 max-w-2/3">
          <Translate>Integrated security solution to protect your assets</Translate>
        </div>
        <div className="text-center text-[#333] text-opacity-70 text-base font-normal leading-normal max-w-2/3">
          <Translate>
