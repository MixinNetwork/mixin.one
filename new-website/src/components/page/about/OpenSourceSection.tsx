...
export const OpenSourceSection = () => (
  <div className="container mx-auto flex flex-col sm:flex-row-reverse ">
    <img src={require("@site/static/img/page/about/1.png").default} className="aspect-375/250 sm:aspect-432/380 object-cover w-full h-full sm:max-h-95 sm:h-auto sm:w-fit" />
