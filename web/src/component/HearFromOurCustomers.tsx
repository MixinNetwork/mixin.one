...
import Slider from "../app/[locale]/(feature)/license/Slider"
import QuotationMark from "../app/[locale]/(feature)/license/quotationMark.svg"
  ...
  <>
    ...
    <div>
      <div className="aspect-375/250 mt-15 relative">
        <Image src="/HearFromOurCustomers.png" alt={"Hear from our customers"} fill className="object-cover" />
      </div>
