...
export const SolutionSection = (props: LLProps) => (
  <>
    ...
    <div className="pt-15 pb-20 sm:pb-22.5 px-10 grid gap-y-5 gap-x-8 sm:grid-cols-2 w-full sm:w-fit sm:mx-auto">
      <Link locale={props.locale} href="/tecnology" className="sm:px-10 h-12 flex-center bg-neutral-800 rounded-sm text-white text-base font-medium">
        How it Secure
      </Link>
