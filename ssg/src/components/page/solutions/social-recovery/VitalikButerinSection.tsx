...
export const VitalikButerinSection = () => (
  <WoodGrainBackgroundTextSection>
    <div className="mx-a grid w-fit grid-cols-[auto_1fr_auto]">
      <QuotationMark />
      <div className="w-fit" />
      <QuotationMark className="rotate-y-180" />
      <div />
      <div className="text-4 sm:text-4.7 md:text-5.3 lg:text-6 font-300 sm:font-333.3 md:font-366.7 lg:font-400 mx-0-10 w-fit">
