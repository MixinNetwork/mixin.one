...
export const AuditReportSection = () => (
  <div className="bg-zinc-100 bg-opacity-50">
    <div className="sm:pt-50 md:py-27 gap-x-27.5 container mx-auto grid gap-y-20 px-5 pb-40 pt-20 text-center sm:pb-20 md:grid-cols-[474fr_356fr] md:text-start">
      <div className="md:py-12.5 flex flex-col justify-center">
        <div className="text-3xl font-medium leading-10 text-[#333]">
          <Translate>Security Audits</Translate>
        </div>
        <div className="mt-5 text-base font-normal leading-normal text-[#333] text-opacity-60">
          <Translate>
