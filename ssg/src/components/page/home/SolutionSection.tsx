  ...
  <>
    <div className="mt-25 md:mt-30 sm:px-21.7 md:px-33.3 lg:px-45 container mx-auto space-y-5 px-10 text-center font-medium md:space-y-6 lg:space-y-8">
      ...
      <div className="text-sm text-[#333] text-opacity-80 sm:text-base">
        <Translate>
          Bitcoin custody should never sacrifice decentralization, always be
          confident and reliable. Mixin Safe also makes decentralized recovery
          and inheritance possible.
        </Translate>
      </div>
    </div>
    <div className="sm:mb-25 md:mb-30 lg:mt-14.5 mb-20 mt-20 grid w-full gap-x-8 gap-y-5 px-10 sm:mx-auto sm:mt-12 sm:w-fit sm:grid-cols-2">
      <LocalLink
        to="/how-it-secures"
