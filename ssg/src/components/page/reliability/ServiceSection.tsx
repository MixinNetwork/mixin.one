...
const Item = ({
  ...
  <div className="pb-26 text-#333 rounded-sm bg-zinc-100 px-5 pt-7">
    {icon}
    <div className="mt-10.5 text-5 font-medium leading-snug">{title}</div>
    <div className="text-4 mt-5 font-normal leading-7">{description}</div>
  </div>
)
