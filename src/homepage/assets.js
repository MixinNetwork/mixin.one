const assets = {
  ...
  mn_crypto_note_url: require('./assets/mn_crypto_note.png'),
  mn_dag_url: require('./assets/mn_dag.png'),
  mn_domain_url: require('./assets/mn_domain.png'),
  mn_kernal_url: require('./assets/mn_kernal.png'),
  mn_tee_url: require('./assets/mn_tee.png'),
  mtg_flexible_url: require('./assets/mtg_flexible.png'),
  mtg_security_url: require('./assets/mtg_security.png'),
